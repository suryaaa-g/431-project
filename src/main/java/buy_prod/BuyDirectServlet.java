		...
		out.println("<!DOCTYPE html>\n"
				...
				try {
					...
					if (seller.equals((String)session.getAttribute("user"))) {
						out.println("Error: You cannot buy your own listing. <div><a href='End/BrowseItems/browseProducts.jsp'>Return to the Buy page.</a>");
					}
					else if(amountFloat != curr_price ) {
						out.println("The price you entered does not match the price of the product!!");
						...
						out.println("One of your entry fields is empty, please try again. <div><a href='GetImageServlet'> Try again</a></div>");
